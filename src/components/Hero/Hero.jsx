...
const Hero = () => {
  return (
    <section className="h-64 md:h-96 lg:h-128 group relative">
      ...
      <div className="absolute bottom-0 w-full bg-gradient-to-b from-transparent to-black">
        <div className="container pl-10 lg:pl-0">
          ...
          <p className="text-gega-grey group-hover:mb-2 duration-500 text-sm lg:text-base w-3/4 lg:w-2/3">
            ...
            laborum ad fugit distinctio culpa perferendis soluta repellendus
            delectus non aliquam!
          </p>
      ...
      <div className="flex  space-x-3 absolute   md:justify-center md:items-center md:relative bottom-5 md:bottom-8 left-10 opacity-0 group-hover:opacity-100 duration-1000">
            <div className="w-3 h-3 lg:w-4 lg:h-4  rounded-full bg-gega-red cursor-pointer"></div>
            <div className="w-3 h-3 lg:w-4 lg:h-4 rounded-full bg-gega-grey cursor-pointer"></div>
            <div className="w-3 h-3 lg:w-4 lg:h-4 rounded-full bg-gega-grey cursor-pointer"></div>
            <div className="w-3 h-3 lg:w-4 lg:h-4 rounded-full bg-gega-grey cursor-pointer"></div>
      </div>
    </section>
